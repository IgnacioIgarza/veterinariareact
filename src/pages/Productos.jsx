  ...
  return (
    <>
      <div className="container mt-4">
        <h1>Productos de tienda de mascotas</h1>
        {/* Barra de búsqueda */}
            ...
            <div key={producto.id} className="col-12 col-md-6 col-lg-4 mb-4">
              <div className="card h-100">
                <img
                  ...
                  style={{ height: "auto", objectFit: "cover", width: "150px"}}
                />
                  ...
                  <div className="mt-auto">
                    <div className="d-grid gap-2">
                      ...
                      <button
                        ...
                        style={{ backgroundColor: '#0669aa', color: 'white' }}
                      >
                        Agregar al carrito
                      </button>
                    </div>
  ...
  <li className="tarjeta-item">
   ...
   <div>
      <Link to={`/productos/${producto.id}`} state={{producto}}>
        <button className="btn-masDetalles">Más detalles</button>
      </Link>
      <button onClick={onAgregarCarrito} className="btn-comprar">Comprar</button>
    </div>
