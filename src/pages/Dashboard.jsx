  ...
  return (
    <div style={{ padding: '20px', minHeight: '60vh' }}>
      ...
      <div style={{ background: '#f5f5f5', padding: '20px', borderRadius: '8px' }}>
        ...
        {/* TOKEN */}
        <div style={{background: '#e9ecef',padding: '10px',borderRadius: '4px',margin: '10px 0',fontSize: '14px'}}>
        ...
        <div style={{ margin: '20px 0' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginTop: '10px' }}>
            <button
              ...
              color: 'white',textDecoration: 'none',borderRadius: '4px',border: 'none',cursor: 'pointer',display: 'inline-block'}}>
              Agregar Productos
            </button>
            <Link
              to="/productos"
              style={{ padding: '10px 20px',background: '#17a2b8', color: 'white', textDecoration: 'none', borderRadius: '4px', display: 'inline-block' }}>
        ...
        <button
          ...
          style={{padding: '10px 20px', background: '#dc3545',
            color: 'white',border: 'none', borderRadius: '4px',cursor: 'pointer',marginTop: '10px'}}>
          Cerrar sesión
        </button>
      </div>
    </div>
